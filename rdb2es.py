...
def cli(index_name, delete_index, mapping_file, settings_file, doc_type, host,docs_per_chunk, bytes_per_chunk, parallel, quiet, parser,config_file,user,passwd):

    with open(config_file, "rb") as f:
        con = json.loads(f.read())
    host = con['es_conf']['host']
